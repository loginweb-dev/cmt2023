  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        ...
        <a href="index.html"><img src="https://panel.cmt.gob.bo//storage/navbar.jpg" alt="" class="img-fluid"></a>
      </div>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Mi Concejo</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a class="nav-link scrollto" href="#team">Estructura del Consejo</a></li>
              <li><a class="nav-link scrollto" href="#testimonials">Reglamento General</a></li>
              <li><a class="nav-link scrollto" href="#testimonials">Sesion en Vivo</a></li>
              <li><a class="nav-link scrollto" href="#testimonials">Correo Institucional</a></li>
              
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="#services">Gaceta Oficial</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Convocatorias</a></li>
          <li><a class="nav-link scrollto" href="#pricing">Noticias</a></li>
        </ul>
      ...
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
          <div>
            ...
            <p>Órgano Municipal deliberante, legislador y fiscalizador de la gestión municipal</p>
          </div>
        </div>
