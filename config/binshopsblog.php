...
return [
    ...
    'image_sizes' => [
        ...
        // There must be only three sizes - image_large, image_medium, image_thumbnail.
            ...
            'image_main' => [ // this key must start with 'image_'. This is what the DB column must be named
            'w' => 1024, // width in pixels
            'h' => 1024, //height
            'basic_key' => "main", // same as the main key, but WITHOUT 'image_'.
            'name' => "Main", // description, used in the admin panel
    ...
    'rssfeed' => [
        ...
        'language' => "es", // see https://www.w3.org/TR/REC-html40/struct/dirlang.html#langcodes
    ],
